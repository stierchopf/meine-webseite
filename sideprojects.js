...
// NEU: Swipe-Funktion hinzufügen (für Touch-Geräte)
let startX = 0;
let endX = 0;
const minSwipeDistance = 50; // Mindestdistanz für einen gültigen Swipe (in Pixeln)
...
modal.addEventListener('touchmove', function(e) {
    e.preventDefault(); // Verhindert Scrollen während des Swipens
});
...
// Optional: Maus-Drag-Support für Desktop (ähnlich wie Swipe)
